...
class AppointmentService:
    def __init__(self, repository: AppointmentRepository, email_service: EmailService):
    ...
    def create(self, appointment: Appointment) -> Appointment:
        ...
        if existing:
            raise HTTPException(status_code=400, detail="Esa hora ya está reservada para el médico")
    ...
    def get_all(self):
        ...
        if not appointments:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="No hay citas registradas")
        return appointments
    ...
    def get_schedule_status(self, medic_name: str, day: date) -> Dict[str, List[str]]:
